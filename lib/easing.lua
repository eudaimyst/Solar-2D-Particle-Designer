...
-- easing.lua
--
-- Code is Mlicensed; see https://www.coronalabs.com/links/code/license
-- Now https://solar2d.com
--
-------------------------------------------------------------------------------

-- NOTE: easing is assigned to global var "easing" on startup.
...
-- easing table. variable legend follows
...
-- per convention params are to be called:
--t, tMax, start, delta
...
-- old lib params order is t, tMax, start, delta
-- new lib params order is t, start, delta, tMax
...
easing.myFlash = function( t, tMax, start, delta)
	local interval = t / tMax
	if interval < 0.5 then
		return .7
	else
